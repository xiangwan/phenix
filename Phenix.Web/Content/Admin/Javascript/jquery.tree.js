...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        var dfop =
        {
            ...
            datatype: "json",
            url: false,
            cbiconpath: "/Content/Admin/images/icons/",
            icons: ["checkbox_0.gif", "checkbox_1.gif", "checkbox_2.gif"],
            emptyiconpath: "/Content/Admin/images/icons/s.gif",
...
//冒泡的祖先
        ...
        function builparam(node) {
            var p = [
                { name: "id", value: encodeURIComponent(node.id) }, { name: "text", value: encodeURIComponent(node.text) }, { name: "value", value: encodeURIComponent(node.value) }, { name: "checkstate", value: node.checkstate }
            ];
            return p;
        }
