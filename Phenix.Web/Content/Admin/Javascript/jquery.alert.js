(function(a) {
    a.alerts = {
        ...
        _show: function(j, b, k, g, m, l, c, f, n) {
            ...
            var pp = a("#popup_container");
            if (pp.length == 0) {
                a(document.body).append('<div id="popup_container" style="display:none"><h1 id="popup_title"></h1><em id="ctl"></em><em id="cbl"></em><em id="ctr"></em><em id="cbr"></em><span id="popup_close"></span><div id="popup_content"><div id="popup_message"></div></div></div>');
            } else {
                a("#popup_panel").remove();
            }
            if (a.alerts.dialogClass && !a("#popup_container").hasClass(a.alerts.dialogClass)) {
        ...
        _reposition: function() {
            var c = ((document.documentElement.clientHeight / 2) - (a("#popup_container").height() / 2)) + a.alerts.verticalOffset;
            var b = ((document.documentElement.clientWidth / 2) - (a("#popup_container").width() / 2)) + a.alerts.horizontalOffset;
            if (c < 0) {
                c = 0
            }
            if (b < 0) {
            ...
            a("#popup_overlay").height(document.documentElement.clientHeight);
        },
