    ...
    public static class SqlMapperExtensions
    {
        ...
        private static IEnumerable<PropertyInfo> TypePropertiesCache(Type type)
        {
            ...
            var properties = type.GetProperties().Where(IsWriteable).
                Where(p => !p.PropertyType.FullName.StartsWith("Phenix")).ToArray();//WARN hack，去除poco属性
        ...
        private static string GetTableName(Type type)
        {
            ...
            return name;
          //  return type.Name;//WARN 改为domain name,必须与数据库表名一致
        }
...
public class SqlServerAdapter : ISqlAdapter
{
	public int Insert(IDbConnection connection, IDbTransaction transaction, int? commandTimeout, String tableName, string columnList, string parameterList, IEnumerable<PropertyInfo> keyProperties, object entityToInsert)
	{
        ...
        LogManager.GetCurrentClassLogger().Info(cmd);
